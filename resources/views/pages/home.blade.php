                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-surface-container-high mt-1">Seamless curriculum
                                continuity from Early Childhood (Toddler &amp; Kindergarten), Primary, Junior High, to High
                                School.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-surface-container-high mt-1">100% English instructional
                                immersion, enhanced by specialized Mandarin language electives.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-surface-container-high mt-1">
                                A balanced synthesis of moral integrity, social empathy, and future-ready global leadership
                                values.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-surface-container-high mt-1">Dedicated higher
                                education counseling from Grade 9 toward Ivy League, Russell Group, Australia Go8, and top
            ...
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-md">
                        ...
                        social-emotional development, cognitive mastery, and emergent leadership at every developmental
                        stage.
                    </p>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
                <div class="text-center max-w-3xl mx-auto mb-10">
                    ...
                    <p class="font-body-lg text-body-lg text-on-surface-variant mt-3">
                        A seamless blend of fast online registration from home and on-campus document verification to ensure
                        data validity and a comfortable experience for your child.
                    </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 relative">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span
                                ...
                                Portal</span>
                            <h3 class="font-headline-sm text-headline-sm text-primary font-bold mb-2">Account Registration
                            </h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Fill in student &amp; parent details via this portal, choose the academic division
                                (EY/Primary/Middle/High), and receive your <strong>Official Registration ID</strong> via
                                SMS/WhatsApp.
                            </p>
                        </div>
                        <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span
                                class="font-label-sm text-label-sm text-secondary font-bold uppercase tracking-wider mb-1 block">Online
                                / Download</span>
                            <h3 class="font-headline-sm text-headline-sm text-primary font-bold mb-2">Document Checklist
                            </h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Download the registration confirmation slip and prepare copies of the Family Card, Birth
                                Certificate, passport photos, and academic records from previous school years.
                            </p>
                        </div>
                        <div
                            class="w-full mt-4 pt-3 flex items-center gap-1.5 text-primary font-label-sm text-label-sm font-semibold border-t border-surface-container-high/40">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3 class="font-headline-sm text-headline-sm text-primary font-bold mb-2">Verification &amp;
                                Observation</h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Visit our Admissions Center for physical original document validation and child-friendly
                                observation sessions (readiness test/talent and interest interview).
                            </p>
                        </div>
                        <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Access the announcement results transparently using your Registration ID or view directly on
                                the bulletin board at the school main lobby.
                            </p>
                        </div>
                        <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3 class="font-headline-sm text-headline-sm text-primary font-bold mb-2">Re-enrollment &amp;
                                Uniforms</h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Complete institutional enrollment administration, official uniform fitting measurements, and
                                pick up the new student orientation starter pack.
                            </p>
                        </div>
                        <div
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-body-sm text-body-sm text-on-surface-variant">Our Admissions Officers are
                                available to assist you with the application process via video consultation or in-person
                                guidance.</p>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div class="lg:col-span-5 flex flex-col gap-6">
                        <span
                            class="font-label-sm text-label-sm text-secondary uppercase tracking-widest font-bold">Transparent
                            Tuition &amp; Scholarships</span>
                        <h2 class="font-headline-xl text-headline-xl text-primary">The Best Investment for Your Child's
                            Future</h2>
                        <p class="font-body-md text-body-md text-on-surface-variant">
                            Unity School implements a fully transparent tuition framework with no hidden fees throughout the
                            academic year, complemented by 0% interest installment plans through leading partner banks.
                        </p>
                        ...
                        <div class="space-y-4">
                            <div class="p-4 rounded-xl bg-surface-container-low flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-headline-sm text-headline-sm text-primary">Sibling Privilege Discount
                                    </h4>
                                    <p class="font-body-sm text-body-sm text-on-surface-variant mt-0.5">Development Fee
                                        reduction of 10% for the second child, and 15% for the third child enrolled.</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 rounded-xl bg-surface-container-low flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-headline-sm text-headline-sm text-primary">Unity Global Merit
                                        Scholarship</h4>
                                    <p class="font-body-sm text-body-sm text-on-surface-variant mt-0.5">Up to 100% tuition
                                        waiver for international academic/arts olympiad medalists and exceptional talent
                                        achievements.</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 rounded-xl bg-surface-container-low flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-headline-sm text-headline-sm text-primary">0% Flexible Installment Plan
                                    </h4>
                                    <p class="font-body-sm text-body-sm text-on-surface-variant mt-0.5">Convenient payment
                                        options for the Institutional Development Fee (DPP) divided into 3x or 6x terms per
                                        semester.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-7">
                        <div class="rounded-xl bg-surface-container-lowest p-8 shadow-xl">
                            <div class="flex items-center justify-between pb-6">
                                <div>
                                    <span
                                        class="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Initial
                                        Cost Simulation</span>
                            ...
                            <div class="space-y-4 pb-6">
                                <div class="flex justify-between items-center py-2.5 border-b border-surface-container">
                                    <span class="font-body-md text-body-md text-on-surface-variant">Application &amp;
                                        Assessment Fee</span>
                                ...
                                <div class="flex justify-between items-center py-2.5 border-b border-surface-container">
                                    <div class="flex flex-col">
                                        <span class="font-body-md text-body-md text-on-surface-variant">Development Fee /
                                            DPP (One-Time per Tier)</span>
                                        <span id="tier-dpp-discount"
                                            class="font-label-sm text-label-sm text-tertiary font-semibold">Includes Early
                                            Bird Discount -IDR 8,000,000</span>
                                    </div>
                                    <div class="text-right">
                                        <span id="tier-dpp-original"
                                            class="line-through text-on-surface-variant font-body-sm text-body-sm block">IDR
                                            38,000,000</span>
                                        <span id="tier-dpp-final"
                                            class="font-headline-sm text-headline-sm text-primary font-bold">IDR
                                            30,000,000</span>
                                    </div>
                                </div>

                                <div class="flex justify-between items-center py-2.5 border-b border-surface-container">
                                    <span class="font-body-md text-body-md text-on-surface-variant">Monthly Tuition
                                        (Includes Digital Books &amp; Labs)</span>
                                ...
                                <div class="flex justify-between items-center py-2.5 border-b border-surface-container">
                                    <span class="font-body-md text-body-md text-on-surface-variant">Complete 5-Set Uniform
                                        Package</span>
                                    <span class="font-headline-sm text-headline-sm text-primary font-bold">Complimentary
                                        (Early Bird Wave 1)</span>
                                </div>
                            </div>

                            <!-- Total Savings Summary -->
                            <div class="p-4 rounded-xl bg-surface-container flex items-center justify-between">
                                <span class="font-label-lg text-label-lg text-primary font-semibold">Estimated Total
                                    Savings</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div class="md:col-span-2 rounded-xl bg-surface-container-lowest overflow-hidden shadow-sm group">
                        ...
                        <div class="p-6">
                            ...
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Equipped with 3D printing, IoT sensors, and modern coding workstations where students
                                develop
                                computational thinking and excel in prestigious national and international science
                                competitions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-xl bg-surface-container-lowest overflow-hidden shadow-sm group">
                        ...
                        <div class="p-6">
                            <h3 class="font-headline-md text-headline-md text-primary mb-2">Semi Olympic
                                Swimming Pool</h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Heated ozone-filtered pool meeting international aquatic safety standards, supervised by
                    ...
                    <div class="rounded-xl bg-surface-container-lowest overflow-hidden shadow-sm group">
                        ...
                        <div class="p-6">
                            <h3 class="font-headline-md text-headline-md text-primary mb-2">Grand Performing Arts
                                Hall</h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                A 600-seat acoustic auditorium built for orchestral performances, theatre productions, and
                                major ceremonial assemblies.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 rounded-xl bg-surface-container-lowest overflow-hidden shadow-sm group">
                        ...
                        <div class="p-6">
                            ...
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                Access to over 45,000 physical titles alongside premier digital research databases,
                                supported by comfortable multimedia group discussion pods.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 rounded-xl bg-surface-container-lowest overflow-hidden shadow-sm group">
                        ...
                        <div class="p-6">
                            <h3 class="font-headline-md text-headline-md text-primary mb-2">Campus Grand Sanctuary
                                &amp; Reflection Hall</h3>
                            <p class="font-body-sm text-body-sm text-on-surface-variant">
                                A serene environment dedicated to character cultivation, daily worship, and structured
        ...
        <section id="testimonials" class="w-full py-space-lg bg-surface scroll-mt-24">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center max-w-2xl mx-auto mb-4">
                    <span class="font-label-sm text-label-sm text-secondary uppercase tracking-widest font-bold">Voices of
                        Parents &amp; Alumni</span>
                    <h2 class="font-headline-xl text-headline-xl text-primary mt-2">Why Families Choose Unity School</h2>
                    <p class="font-body-md text-body-md text-on-surface-variant mt-2">
                        Real stories of transformative growth, global academic excellence, and grounded character
                        development.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="p-8 rounded-xl bg-surface-container-lowest shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <p class="font-body-md text-body-md text-on-surface italic mb-6">
                                "My child enrolled in Kindergarten and is currently thriving in Grade 5 Primary. Her English
                                communication confidence blossomed naturally without undue pressure, while core moral
                                integrity and personal discipline remain firmly rooted at home."
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4">
                            ...
                            <div>
                                <span class="font-headline-sm text-headline-sm text-primary block">Dr. Sarah
                                    Daniswara</span>
                                <span class="font-label-sm text-label-sm text-on-surface-variant">Primary Parent (Grade
                                    5)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 rounded-xl bg-surface-container-lowest shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <p class="font-body-md text-body-md text-on-surface italic mb-6">
                                "The faculty advisors at Unity High School provided dedicated guidance for our son since
                                Grade 10, refining his talent portfolio, critical thinking, and technical projects. He
                                graduated with immense self-reliance and earned gold distinctions in national science
                                competitions."
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4">
                            ...
                            <div>
                                <span class="font-headline-sm text-headline-sm text-primary block">Ir. Rahmat
                                    Mulyadi</span>
                                <span class="font-label-sm text-label-sm text-on-surface-variant">Alumni Parent, Class of
                                    2024</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 rounded-xl bg-surface-container-lowest shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <p class="font-body-md text-body-md text-on-surface italic mb-6">
                                "Moving from an international school in Singapore to Jakarta was seamless for my daughter.
                                Unity's Cambridge framework kept her academic momentum intact while giving her an inclusive,
                                welcoming community with a profound sense of belonging."
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4">
                            <div
                            ...
                            <div>
                                ...
                                <span class="font-label-sm text-label-sm text-on-surface-variant">Expatriate Parent, Junior
                                    High School (Grade 8)</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 pb-8">
                        <div>
                            ...
                            <p class="font-body-md text-body-md text-on-surface-variant max-w-xl mt-2">
                                Each academic tier is supported by a dedicated admissions specialist ready to guide you
                                through observational procedures, curriculum details, and relevant assessments.
                            </p>
                        </div>
        ...
        <section id="apply-now"
            ...
            <div class="max-w-5xl mx-auto px-6 text-center">
                ...
                <p
                    ...
                    Take advantage of exclusive Early Bird privileges and complimentary academic consultation sessions with
                    our experienced admissions advisors today.
                </p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            buttons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    buttons.forEach(b => {
                        b.className =
                            'py-2.5 px-3 rounded-lg text-on-surface-variant hover:text-primary font-medium transition-all';
                    });

                    // Set styling tombol aktif
                    this.className =
                        'py-2.5 px-3 rounded-lg bg-surface-container-lowest text-primary font-bold shadow-sm transition-all';
                    ...
                    if (data) {
                        ...
                        if (sppEl) sppEl.innerHTML =
                            `${data.spp} <span class="text-body-sm font-normal text-on-surface-variant">/mo</span>`;
